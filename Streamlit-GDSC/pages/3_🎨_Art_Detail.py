    ...
    with st.container(height=250):
        if ask:
            prompt = f'''You are a professional art instructor, you are given a painting {selected_row["TITLE"]} by {selected_row["AUTHOR"]}, 
                    ...
                    I want you to not only describe the visual elements of the cropped section but also interpret the meaning, skills, and anything behind it.
                    '''
            ...
            with st.chat_message("Artist", avatar = "👩‍🎨"):
                ...
                response = model.generate_content([prompt, cropped_img, resized_img])
                response.resolve()
