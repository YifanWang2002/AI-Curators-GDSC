...
st.title("AI Curators 🖼️ - GDSC 2024 Hackathon Demo")
...
with st.expander("System Design 💻"):
    st.write("We have provisioned our system to be build in this way:")
    st.image("images/AI Curator Vision Diagramming - System.jpg")    
    st.image("images/AI Curator Vision Diagramming - Data preprocess.jpg")    
    st.image("images/AI Curator Vision Diagramming - Endpoint 1.jpg")    
    st.image("images/AI Curator Vision Diagramming - Endpoint 2.jpg")    


with st.expander("Future Work: Expanding Horizons with AI and Google 🚀"):
    st.write('''
    *Our technical team is deeply committed to developing those features. Due to their complexity and our ongoing efforts to gather more data, we anticipate continuously rolling out those features starting from March.*
    ...
    2. **AI Learning System 📚**:
       - **Incentive System**: Implementing an ML-based incentive system akin to Duolingo. This system will set up tasks and rewards to encourage users to engage more with our platform.
    
    3. **3D Model Generation 🌐**:
       - **3D Gaussian Splatting with Diffusion Models**: Utilizing Google's advanced Nerf and other 3D Reconstruction services to generate digitized models of museum collections from video clips, employing techniques like 3D Gaussian Splatting combined with diffusion models.

    4. **Intriguing Educational Games 🎮**:
       - **Style Transfer**: Leveraging Google AI's Cognitive Services for artistic style transfer in games.
       - **Find the AI-Generated Imposter**: Creating games where users identify AI-generated artworks, using Google's AI capabilities.
       - **Coloring Book Generation**: Generating coloring books from famous artworks using Google's Imagen tools.
       - **AI Persona of Famous Artists**: Creating interactive AI personas of famous artists using Google's AI services, including RAG (Retrieval-Augmented Generation) technology for animated conversations about their experiences and artworks.

    Our journey ahead is focused on harnessing these advanced Google Cloud and AI services to enhance the educational and artistic experience for users worldwide.
...
with st.expander("References & Acknowledgements 👏"):
    st.write("We owe a huge thank you to Google Developers Student Club at CMU who hosted the competition and the resources provided.")
